...
public class ServiceOrderListActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, IOrderListView, IGoodsinfoView, IOrderInfoView {
    ...
    public void cancleAction(String orderId, String status) {
        ...
        builder.setTitle("提示").setMessage("您确定要取消订单吗").setPositiveButton("取消订单", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                iOrderInfoPres.cancleGoodsOrder((String) SaveUtils.get(ServiceOrderListActivity.this, SpValue.TOKEN, ""), orderId
                        , status);
            }
    ...
    public void confirmGetGoods(String orderId) {
        ...
        builder.setTitle("提示").setMessage("确认收货").setPositiveButton("已收货", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                //确认收货
                iDeletePres.confirmReceive((String) SaveUtils.get(ServiceOrderListActivity.this, SpValue.TOKEN, ""), orderId);
    ...
    public void go2use(String orderId) {
        ...
        builder.setTitle("提示").setMessage("确认使用该订单吗").setPositiveButton("确认使用", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                //使用服务订单
                iOrderInfoPres.useServiceOrder((String) SaveUtils.get(ServiceOrderListActivity.this, SpValue.TOKEN, ""), orderId);
    ...
    public void deleteOrder(String orderId) {
        ...
        builder.setTitle("提示").setMessage("您确定要删除该订单吗").setPositiveButton("删除订单", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                //删除订单
                iDeletePres.deleteGoodsOrder((String) SaveUtils.get(ServiceOrderListActivity.this, SpValue.TOKEN, ""), orderId);
            }
        }).setNegativeButton("取消", null).show();
