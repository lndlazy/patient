package com.ylean.cf_hospitalapp.utils.alipay;
...
public class OrderInfoUtil2_0 {
	 ...
	 * @return
	 */
	public static Map<String, String> buildOrderParamMap(String app_id, String body, double price
			,String subject, String orderNum, String notify_url, String sellerID) {
		Map<String, String> keyValues = new HashMap<String, String>();
...
//		keyValues.put("timestamp", "2016-07-29 16:55:53");
        String dateTime = IDateUtils.formatDateTime(new Date(), IDateUtils.DF_YYYY_MM_DD_HH_MM_SS);
        keyValues.put("timestamp", dateTime);

//		Logger.d("参数::" +  "{\"timeout_express\":\"30m\"" +
...
//		Logger.d("其他参数::" +  dateTime);
	...
	public static String getSign(Map<String, String> map, String rsaKey, boolean rsa2) {
		...
		for (int i = 0; i < keys.size() - 1; i++) {
			String key = keys.get(i);
			String value = map.get(key);
//			Logger.d("签名key:" + key + ",value:" + value);
