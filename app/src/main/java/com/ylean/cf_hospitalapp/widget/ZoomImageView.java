...
//import android.view.MGestureDetector;
...
// */
//
//public class ZoomImageView extends SimpleDraweeView implements ViewTreeObserver.OnGlobalLayoutListener, ScaleGestureDetector.OnScaleGestureListener, View.OnTouchListener {
...
//        //自动缩放时需要有一个自动的过程
//        mGestureDetector = new MGestureDetector(context, new MGestureDetector.SimpleOnGestureListener() {
//            @Override
