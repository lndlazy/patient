...
//        Bitmap bitmap = ((BitmapDrawable) getResources().getDrawable(R.mipmap.ic_recommend_gray)).getBitmap();
...
//    }
//
//    private static final int START_PADDING = 5000;
//
//    /**
//     * 星星
//     *
...
//        Bitmap bitmap = ((BitmapDrawable) getResources().getDrawable(R.mipmap.ic_recomand)).getBitmap();
