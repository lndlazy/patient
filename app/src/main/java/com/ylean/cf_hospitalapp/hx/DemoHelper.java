...
import com.ylean.cf_hospitalapp.hx.db.DemoDBManager;
import com.ylean.cf_hospitalapp.hx.db.InviteMessgeDao;
import com.ylean.cf_hospitalapp.hx.db.UserDao;
import com.ylean.cf_hospitalapp.hx.domain.EmojiconExampleGroupData;
import com.ylean.cf_hospitalapp.hx.domain.InviteMessage;
import com.ylean.cf_hospitalapp.hx.domain.RobotUser;
import com.ylean.cf_hospitalapp.hx.parse.UserProfileManager;
...
//        options.setGCMNumber("324169311137"); //TODO
    ...
    protected void setEaseUIProviders() {
        ...
        easeUI.getNotifier().setNotificationInfoProvider(new EaseNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                Intent intent = new Intent(appContext, HelpChatActivity.class);
...
//            callReceiver = new CallReceiver();   //   这个是用于打电话和视频
//        }
//
...
//        appContext.registerReceiver(callReceiver, callFilter);
    ...
    /**
     * user met some exception: conflict, removed or forbidden  登录账号冲突 ，或被群组移出群聊时，回到主界面
     */
...
//        appContext.startActivity(intent);
	...
	/*private EaseUser getUserInfo(String username){
      ...
      *//*  EaseUser user = null;
        ...
        return user;*//*
        EaseUser user = null;
        if (!TextUtils.isEmpty(EMClient.getInstance().getCurrentUser()) && username.equals(EMClient.getInstance().getCurrentUser()))
        {
            return getUserProfileManager().getCurrentUserInfo();
        }
			...
			public void onMessageReceived(List<EMMessage> messages) {
			    for (EMMessage message : messages) {
                  /*  EMLog.d(TAG, "onMessageReceived id : " + message.getMsgId());
                    ...
                    String userPic = message.getStringAttribute("headImage", "");
                   ...
                   UserCacheManager.save(message.ext());
                    ...
                    String userName = message.getStringAttribute("nickName", "");
                    String userPic = message.getStringAttribute("headImage", "");
                    String userId=message.getStringAttribute("hxname","");
                    Log.e("其他消息获取到的值", userName + "  " + userPic+"id"+userId);
                    ...
                    // 存入db
                    UserDao dao = new UserDao(Mapplication.getInstance());
...
//                        }
                 ...
                 /*   //get message body
                    ...
                    final String action = cmdMsgBody.action();//获取自定义action
                    //透传消息
                    if (action.equals("YSJ_ENTER_CHATROOM_ORDER")) {
                        String userName = message.getStringAttribute("userName", "");
                        String userPic = message.getStringAttribute("headImage", "");

                        Log.e("透传获取到的值", userName + "  " + userPic);
                        Intent intent = new Intent("touchuan");
                        intent.putExtra("headImage", userPic);
